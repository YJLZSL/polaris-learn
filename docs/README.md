...
> **协议**: AGPL-3.0 | **类型**: 纯开源个人学习平台 | **版本**: v2.1.0

## 项目简介

Polaris 是一个面向多年龄段学习者的纯开源个人 AI 学习平台，支持幼儿园、小学、初高中、大学生、上班族 5 种学习模式。无管理后台、无计费、无 API Key 网关，用户自带大模型 API Key（在「设置」页面配置，保存在浏览器本地），所有学习数据由用户自己掌控。
