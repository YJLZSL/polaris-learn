                    ...
                    {data.knowledgeMastery.map((item) => (
                      ...
                      >
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            <Progress value={item.masteryLevel} className={cn("h-1.5 max-w-[120px]", getMasteryColor(item.masteryLevel))} />
                            <span className={cn(
                              "text-xs font-medium",
                    ...
                    {data.weakPoints.map((wp) => (
                      ...
                      >
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            <Progress value={wp.masteryLevel} className="h-1.5 max-w-[120px]" />
                    ...
                    {data.strengths.map((s) => (
                      ...
                      >
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            <Progress value={s.masteryLevel} className="h-1.5 max-w-[120px]" />
