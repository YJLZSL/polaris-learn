        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            ...
            <div className="flex items-center gap-8 text-sm text-slate-400 dark:text-slate-500">
              <Link to="/docs/api" className="hover:text-slate-600 dark:hover:text-slate-300 transition-colors">
                API 参考
              </Link>
              <a href="/openapi.yaml" target="_blank" className="hover:text-slate-600 dark:hover:text-slate-300 transition-colors">
                OpenAPI 规范
              </a>
              <Link to="/docs" className="hover:text-slate-600 dark:hover:text-slate-300 transition-colors">
                文档首页
              </Link>
            </div>
          </div>
